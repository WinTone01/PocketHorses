...
public class ConfirmMenu implements InventoryProvider {
    ...
    public SmartInventory get() {
        return SmartInventory.builder()
                .id("inv")
                .title(PocketHorses.getConfigFile().getString("Confirm-GUI.Title"))
                .size(PocketHorses.getConfigFile().getInt("Confirm-GUI.Size.Rows"), 9)
                .provider(this)
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        contents.set(SlotPos.of(1, 4), ClickableItem.empty(new ItemBuilder()
                ...
                .name(PocketHorses.parseColors(config.getString("Confirm-GUI.Are-You-Sure.Name")))
                .lore(PocketHorses.parseColors(config.getStringList("Confirm-GUI.Are-You-Sure.Lore")))
                .build()));
        ...
        contents.set(SlotPos.of(3, 2), ClickableItem.of(new ItemBuilder()
                ...
                .name(PocketHorses.parseColors(config.getString("Confirm-GUI.Confirm.Name")))
                .lore(PocketHorses.parseColors(config.getStringList("Confirm-GUI.Confirm.Lore")))
        ...
        contents.set(SlotPos.of(3, 6), ClickableItem.of(new ItemBuilder()
                ...
                .name(PocketHorses.parseColors(config.getString("Confirm-GUI.Cancel.Name")))
                .lore(PocketHorses.parseColors(config.getStringList("Confirm-GUI.Cancel.Lore")))
